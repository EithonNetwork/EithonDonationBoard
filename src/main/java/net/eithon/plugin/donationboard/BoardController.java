...
public class BoardController {
	...
	private static ConfigurableMessage needTokensMessage;
	private static ConfigurableMessage howToGetTokensMessage;
	private static ConfigurableMessage playerHasDonatedMessage;
	...
	void enable(EithonPlugin eithonPlugin){
		...
		needTokensMessage = config.getConfigurableMessage("messages.NeedTokens", 0,
				"You must have E-tokens to raise the perk level.");
		howToGetTokensMessage = config.getConfigurableMessage("messages.HowToGetTokens", 0,
				"You get E-tokens by donating money at http://eithon.org/donate.");
		playerHasDonatedMessage = config.getConfigurableMessage("messages.PlayerHasDonated", 1,
	...
	private void broadCastDonation(Player player) {
		playerHasDonatedMessage.broadcastMessage(player.getDisplayName());
	}
